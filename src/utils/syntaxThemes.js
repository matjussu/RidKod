/**
 * Shared Syntax Highlighting Themes
 * Used by CodeBlock, WelcomeCodeTagline, AnimatedCodeSnippet
 */
 ...
 *
 * Color palette:
 * - Keywords (def, for, if, while, etc.): Blue #1871BE
 * - Functions/Builtins (print, len, sum, etc.): Orange #D26812
 * - Strings: Green #088201
 * - Numbers: Purple #B401A5
 * - Variables: Light Blue #9CDCFE
 * - Comments: Green #6A9955 (italic)
 * - Operators/Punctuation: Light Gray #D4D4D4
 */
